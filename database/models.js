...
db.sync({ force: true }).then(() => {
  ...
  Employee.create({
    employee_id: '95', employee_name: 'Eric', manager_privilege: true,
  });
  Employee.create({
  ...
  Item.create({
    item_name: 'Hamburger', item_price: 5.50, item_image: 'https://www.rallys.com/wp-content/uploads/2017/03/BigBuford_Feature_1000x1000-600x600.jpg', item_ingredients: '[1, 2, 3, 4, 5, 6]', item_category: 2,
  });
  Item.create({
